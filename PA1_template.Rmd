...
```
The mean of total number of steps taken per day is `r my_mean`.  The median of total number of steps taken per day is `r my_median`
...
```
The interval containing the highest value is `r max_value`  
...
```
The mean of total number of steps taken per day is `r my_mean_new`.  The median of total number of steps taken per day is `r my_median_new`
